...
for spot in spots_data:
    ...
    print(f"  {'✓' if created else '○'} {spot['name']}")
...
for product in products_data:
    ...
    print(f"  {'✓' if created else '○'} {product['name']}")

print("\n" + "="*50)
print(f"✅ IMPORT COMPLETE!")
print(f"   Beauty Spots: {BeautySpot.objects.count()} / 12")
print(f"   Products: {Product.objects.count()} / 15")
